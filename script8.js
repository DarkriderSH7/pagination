...
var container=myDOM('div','container','container');
document.body.append(container)

var table=myDOM('table','table')
...
var ul=myDOM('ul',"pagination")
nav.append(ul)

for(i=1;i<=10;i++){
    this["link" +i]=myDOM('li','page-item')

}

ul.append(link1,link2,link3,link4,link5,link6,link7,link8,link9,link10)
for(i=1;i<=10;i++){
    this['attr'+i]=myDOM('a','page-link')
    this['attr'+i].innerHTML=i;
}
for(i=1;i<=10;i++){
    this["link"+i].append(this['attr'+i])
}
var previous=myDOM('li','page-item')
ul.prepend(previous)
var ptext=myDOM('a','page-link')
  
var next=myDOM('li','page-item')
ul.append(next)
var ntext=myDOM('a','page-link')
 

for(j=1;j<=10;j++){
    this['attr'+j].addEventListener('click',function(j)
    {   
...
function myDOM( elem, elemClass = "", elemID ="", elemName ="")
{     
    let element = document.createElement(elem);     
    element.setAttribute("id",elemID);     
    element.setAttribute("class",elemClass);     
    element.setAttribute("name",elemName);     
    return element; 
}
for(i=1;i<=10;i++){
    this["link" +i]=myDOM('li','page-item')
